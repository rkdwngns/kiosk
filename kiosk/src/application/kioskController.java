...
public class kioskController implements Initializable {
	@FXML Button btnM1p,btnM1m,btnM3m,btnM3p,btnM2p,btnM2m,btnCancel,btnOrder;
	@FXML Label lblamount;
	@FXML TextArea txtOrder;
	
	public int sum=0;
	private String[] orderm = {"아메리카노","카푸치노","카페라때"};
	...
	public void menuAppend() {
		...
		public void btnM1mAction(ActionEvent event) {
			if(countm[0]>0) countm[1]--;
			else countm[0]=0;
			menuAppend();
		}
		public void btnM3mAction(ActionEvent event) {
			if(countm[2]>0) countm[1]--;
			else countm[2]=0;
			menuAppend();
		}
